...
import { FileText, AlertCircle, DownloadCloud, Loader2 } from 'lucide-react';
    ...
    return (
        ...
        >
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 flex flex-col items-center border-b border-gray-100 relative">
                <div className="absolute top-4 right-4 bg-white/60 backdrop-blur-sm px-2 py-1 rounded text-[10px] font-bold text-blue-800 uppercase tracking-wider">
                    {document.space}
                </div>
                ...
                <p className="text-sm font-semibold text-gray-500 mt-1">
                    {formatSize(document.fileSize)} • By {document.uploader}
                </p>
            </div>
            ...
            <div className="p-6">
                ...
                {document.organization && (
                    <p className="text-xs text-center text-gray-400 mt-4 font-medium">
                        Stored in {document.organization}
                    </p>
                )}
            </div>
        </motion.div>
